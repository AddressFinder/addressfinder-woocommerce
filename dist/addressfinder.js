...
var WooCommercePlugin = function () {
  ...
  _createClass(WooCommercePlugin, [{
    key: 'initialiseWidget',
    value: function initialiseWidget(prefix, key, code, onSelectFn, widgetOptions) {
      var widget = new window.AddressFinder.Widget(document.getElementById(prefix + 'address_1'), key, code, widgetOptions);
    ...
    value: function selectNewZealand(a, metaData) {
    ...
    key: 'setFieldValue',
    value: function setFieldValue(elementId, value) {
